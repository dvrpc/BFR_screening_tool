const sources = {
  boundaries: {
    type: "vector",
    url: "https://tiles.dvrpc.org/data/boundaries/municipalboundaries_line",
  },
  plan: {
    type: "geojson",
  ...
  traffic_counts: {
    type: "vector",
    url: "https://tiles.dvrpc.org/data/transportation/trafficcounts",
  },
  bike_counts: {
    type: "vector",
    url: "https://tiles.dvrpc.org/data/transportation/bicyclecounts",
  },
  lts_vector: {
    type: "vector",
