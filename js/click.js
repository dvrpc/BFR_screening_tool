const make_popup_message = (featurelist, lat, lng) => {
  ...
  featurelist.forEach((feature) => {
    ...
    if (feature.layer.source == "plan") {
      ...
      let msg = `
              <p>Lanes: ${feature.properties["totnumlanes"]}</br>
              Speed: ${feature.properties["vehiclespeed"]}</br>
              Slope: ${feature.properties["slope"]}</br>
              </p>`;
      if (messages.indexOf(msg) == -1) {
        messages.push(msg);
      }
      ...
      let msg = `
             <p>
             Bicycle Facility: ${feature.properties["bike_facility"]}
             </p>`;
      if (messages.indexOf(msg) == -1) {
        messages.push(msg);
      }
      ...
      let msg = `
             ...
             PM PTI: ${feature.properties["ptiwkd1519"]}</br>
